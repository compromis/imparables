      ...
      <div className="row">
        ...
        <div className="col-md-12">
          ...
          <div className="embed-responsive embed-responsive-16by9">
            <iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/cOwTNYwvpKQ" frameBorder={0} allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" title="Vídeo 2 anys" allowFullScreen></iframe>
          </div>
        </div>
        <div className="col-md-12 candidate-more">
          <hr className="my-4" />

          <h3>Candidatura al Congreso</h3>

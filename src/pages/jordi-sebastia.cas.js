    ...
    <div className="container candidate-page jordi-sebastia">
      ...
      <div className="row">
        ...
        <div className="col-md-4 d-flex align-items-stretch">
          <Link to="/cas/volem-saber" className="europe-block europe-block--volemsaber">
      ...
      <div className="row">
        <div className="col">
          ...
          <div className="embed-responsive embed-responsive-16by9">
            <iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/jKUW5njCXt4" frameBorder={0} allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" title="Vídeo 2 anys" allowFullScreen></iframe>
          </div>
        </div>
      </div>
    </div>
